 ...
 */
public class ThirdNavigatorContentFragment extends NavigatorContentFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((TextView) this.mRootView.findViewById(R.id.lbl_content_name)).setText(R.string.menu_opton3);
        return this.mRootView;
    }

    @Override
    protected NavigatorMenuOption getMenuOption() {
        return UserUIConfiguration.UserMenu.THIRD;
    }
}
