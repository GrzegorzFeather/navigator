 ...
 */
public class FirstNavigatorContentFragment extends NavigatorContentFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((TextView) this.mRootView.findViewById(R.id.lbl_content_name)).setText(R.string.menu_opton1);
